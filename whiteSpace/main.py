import random
def display_intro(): #this is the intro
...
def make_choice(options): #first part of program, gives you choices
...
def explore_forest(): #this is for the different things you encounter in the forest
...
def play_game(): #this is for when you play the game
    display_intro()
